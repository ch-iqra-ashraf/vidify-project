...
import { allTableData } from "../../../util/generate-tabledata";
...
import { ActionIcons } from "./ActionButtons";
...
export function ProductTable() {
  ...
  const end = Math.min(page * ROWS_PER_PAGE, allTableData.length);
    ...
    <>
      <Table>
        ...
        <Table.Footer>
          <Pagination size="sm">
            <Pagination.Summary>
              {start} to {end} of {allTableData.length} results
            </Pagination.Summary>
            <Pagination.Content>
              <Pagination.Item>
                <Pagination.Previous
